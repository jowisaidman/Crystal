...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Tdl App web application."
  #
  #
  ...
  #
  # settings.secret_key_base= HFLQfwWwNaedk1g5YtSO20xRJkwjSuCwM5xwCae_l9w
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("tdl_app.log", "w"))
  #
  #
end
