...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "App Pet1 web application."
  #
  #
  ...
  #
  # settings.secret_key_base= Qh-cO7nheEx4NwhL3iD4LPq0aU5iQ-5cFfUXWlHDZ3Q
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("app_pet1.log", "w"))
  #
  #
end
