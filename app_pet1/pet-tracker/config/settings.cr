...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Pet Tracker web application."
  #
  #
  ...
  #
  # settings.secret_key_base= OVPR69ZDAFniWmSU-2c7GgUjLTkRjWIY1UmZyVxycEI
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("pet-tracker.log", "w"))
  #
  #
end
