...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Movie App web application."
  #
  #
  ...
  #
  # settings.secret_key_base= kRvvO7PJcNazXNTiIJ2kLUTit_y22Fst89CvLEwuhu4
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("movie_app.log", "w"))
  #
  #
end
