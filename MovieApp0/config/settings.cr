...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Movie App0 web application."
  #
  #
  ...
  #
  # settings.secret_key_base= FS7e24NCQxvaY2XN5N7E5sPhcvXy_QFgumSwdbKK85o
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("movie_app0.log", "w"))
  #
  #
end
